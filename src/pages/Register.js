...
const addReg = async ()=>{
  await addDoc(postCollection, { course, phone, nationality, email, fullName:{ name: auth.currentUser.displayName, id: auth.currentUser.uid, fullName} 
  ...
  return (
    <div className='register'>
      ...
      <>
        ...
        <div>
         <button style={styles} disabled={!input} onClick={addReg}>submit</button>
        </div>
